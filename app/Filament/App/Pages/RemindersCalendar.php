...
{
    protected string $view = 'filament.app.pages.reminders-calendar';
    ...
    public function setCalendarType(string $type)
    {
        if (in_array($type, ['gregorian', 'persian'])) {
            ...
            return redirect(route('filament.app.pages.reminders-calendar') . '?calendar_type=' . $type);
        }
    }
    ...
    {
        return [
            \App\Filament\App\Widgets\RemindersStatsWidget::class,
        ];
    }
    ...
    {
        return [
            \App\Filament\App\Widgets\RemindersCalendarWidget::make([
